...
public class AssassinManager {
    //Alive and Front of the kill ring
    //Alive and Front of the list of the assassins who were eliminated
    private AssassinNode aliveFront;
    private AssassinNode graveyardFront;

    //construct an AssassinManager object from a given list of strings
    //creates a linkedlist of assassin nodes from names in the list
    ...
    //print the kill ring
    //prints kill ring; if only one person is in the kill ring, that person wins
    ...
    //print out graveyard
    //prints graveyard along with their killer; if graveyard is empty nothing happens
    ...
    //returns true if there is only one person in the kill ring; otherwise false
    public boolean isGameOver(){
        return (aliveFront.next == null);
    }

    //helper method
    //name being searched for and give the starting node
    //to indicate to search the graveyard or kill ring
    //determine if one of the linkedlists contains the desired name
    //returns true if name is in the linkedlist; otherwise false
    ...
    //check if a name is in the kill ring
    //returns true if name is found; otherwise false
    public boolean killRingContains(String name){
        return containsHelper(name, aliveFront);
    }

    //check if a name is in the graveyard
    //returns true if name is found; otherwise false
    ...
    //returns the name in the aliveFront of the linked list if the game is over; else false
    ...
    //name of person to be killed
    //kill the name of the person passed
